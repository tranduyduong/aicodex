...
1. Open in new tab, the [GitHub repository for this hackathon.](<../>)

2. Let's create a branch for you to work on the challenges. Click "**main**, type your name as branch name and click "**Create branch ...**.

    <img width="400" alt="Create branch" src="../assets/create branch.png">

3. Click '**<> Code**', and '**Create codespace on ...**'. Ensure you are on the newly created branch.
